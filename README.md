...
- **Late availability** in Results fills a recorded shortage with a worker who was marked **Not here** earlier in that same canvas. The original Not here entry remains in History; it is not undone. The worker receives a normal accepted-work charge of eight hours, the opening counts as covered immediately, and the assignment must still pass RDO, duplicate-shift, regular-work overlap, sixteen-hour, and rest checks. Only Not here marks made at or before that shift are eligible.
